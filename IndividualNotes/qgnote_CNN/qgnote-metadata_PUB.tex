...
% \author[a]{Zihao Jiang}
 %\author[b]{Benjamin Nachman}
 %\author[c]{Francesco Rubbo}
% \author[c]{Ariel Schwartzman}
 %\author[a]{Lauren Tompkins}
...
\AtlasNote{ATL-PHYS-PUB-2017-017}
...
pattern inside a jet processed as an image in a deep neural network classifier.
The study is conducted using simulated dijet events in \mbox{$\sqrt{s}=13$ TeV $pp$} collisions with the ATLAS detector.
...
% List of supporting notes  (leave as null \AtlasCoverSupportingNote{} if you want to skip this option)
 \AtlasCoverSupportingNote{Internal note}{https://cds.cern.ch/record/2267927/}
