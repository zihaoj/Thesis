...
\begin{figure}[htpb!]
\begin{center}
\includegraphics[width=0.45\linewidth]{figures/Unfolding/dR_uncert_summary.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/dphi_uncert_summary.pdf}\\
\includegraphics[width=0.45\linewidth]{figures/Unfolding/ZpT_uncert_summary.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/fracmasspt_uncert_summary.pdf}
...
\begin{enumerate}
  ...
  \begin{figure}[htpb!]
\begin{center}
\includegraphics[width=0.45\linewidth]{figures/Unfolding/dR4_uncert_summary.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/dphi4_uncert_summary.pdf}\\
\includegraphics[width=0.45\linewidth]{figures/Unfolding/ZpT4_uncert_summary.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/fracmasspt4_uncert_summary.pdf}
...
See Sec.~\ref{sec:sub_systematics}. These are treated as fully correlated with the corresponding sources described elsewhere in this section.  The uncertainty breakdown is shown in Fig.~\ref{fig:syst_overview_deltaR2}.
  ...
  \begin{figure}[htpb!]
\begin{center}
\includegraphics[width=0.45\linewidth]{figures/Unfolding/dR2_uncert_summary.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/dphi2_uncert_summary.pdf}\\
\includegraphics[width=0.45\linewidth]{figures/Unfolding/ZpT2_uncert_summary.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/fracmasspt2_uncert_summary.pdf}
\caption[]{A summary of the jet energy systematic uncertainties for all four observables. } 
...
%We compare Sherpa unfolded with Pythia with Sherpa truth.  There is some double-counting with the data-driven non-closure (Sec.~\ref{sec:systs:unfolding}).  The uncertainty breakdown is shown in Fig.~\ref{fig:syst_overview_deltaR2frag}.  

\begin{figure}[htpb!]
\begin{center}
\includegraphics[width=0.45\linewidth]{figures/Unfolding/PythiavsSherpaTruthZpT.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/PythiavsSherpaTruthdR.pdf}\\
\includegraphics[width=0.45\linewidth]{figures/Unfolding/PythiavsSherpaTruthdphi.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/PythiavsSherpaTruthfracmasspt.pdf}
...
\begin{figure}[htpb!]
\begin{center}
\includegraphics[width=0.45\linewidth]{figures/Unfolding/PythiavsSherpavsDataZpT.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/PythiavsSherpavsDatadR.pdf}\\
\includegraphics[width=0.45\linewidth]{figures/Unfolding/PythiavsSherpavsDatadphi.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/PythiavsSherpavsDatafracmasspt.pdf}
...
\end{figure}
  ...
  \begin{figure}[htpb!]
\begin{center}
\includegraphics[width=0.45\linewidth]{figures/Unfolding/ZpT0_uncert_summary.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/dR0_uncert_summary.pdf}\\
\includegraphics[width=0.45\linewidth]{figures/Unfolding/dphi0_uncert_summary.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/fracmasspt0_uncert_summary.pdf}
...
\begin{figure}[htpb!]
\begin{center}
\includegraphics[width=0.3\linewidth]{figures/Unfolding/testPythiaZpT.pdf}\includegraphics[width=0.3\linewidth]{figures/Unfolding/testSherpaZpT.pdf}
\includegraphics[width=0.3\linewidth]{figures/Unfolding/testSherpa_norwZpT.pdf}\\

\includegraphics[width=0.3\linewidth]{figures/Unfolding/testPythiafracmasspT.pdf}\includegraphics[width=0.3\linewidth]{figures/Unfolding/testSherpafracmasspT.pdf}
\includegraphics[width=0.3\linewidth]{figures/Unfolding/testSherpa_norwfracmasspT.pdf}\\

\includegraphics[width=0.3\linewidth]{figures/Unfolding/testPythiadR.pdf}\includegraphics[width=0.3\linewidth]{figures/Unfolding/testSherpadR.pdf}
\includegraphics[width=0.3\linewidth]{figures/Unfolding/testSherpa_norwdR.pdf}\\

\includegraphics[width=0.3\linewidth]{figures/Unfolding/testPythiadphi.pdf}\includegraphics[width=0.3\linewidth]{figures/Unfolding/testSherpadphi.pdf}
\includegraphics[width=0.3\linewidth]{figures/Unfolding/testSherpa_norwdphi.pdf}
...
\begin{figure}[htpb!]
\begin{center}
\includegraphics[width=0.45\linewidth]{figures/Unfolding/noc_factors_dR.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/noc_factors_dphi.pdf}\\
\includegraphics[width=0.45\linewidth]{figures/Unfolding/noc_factors_ZpT.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/noc_factors_fracmasspt.pdf}
...
\begin{figure}[htpb!]
\begin{center}
\includegraphics[width=0.45\linewidth]{figures/Unfolding/noc_datamc_dR.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/noc_datamc_dphi.pdf}\\
\includegraphics[width=0.45\linewidth]{figures/Unfolding/noc_datamc_ZpT.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/noc_datamc_fracmasspt.pdf}
...
\begin{figure}[htpb!]
\begin{center}
\includegraphics[width=0.45\linewidth]{figures/Unfolding/non_uncertainty_mean_dR.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/non_uncertainty_mean_dphi.pdf}\\
\includegraphics[width=0.45\linewidth]{figures/Unfolding/non_uncertainty_mean_ZpT.pdf}\includegraphics[width=0.45\linewidth]{figures/Unfolding/non_uncertainty_mean_fracmasspt.pdf}
